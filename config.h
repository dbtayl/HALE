...
//Return values
typedef enum {HALE_OK = 0, HALE_FAIL, HALE_TILE_POOL_EMPTY, HALE_TILE_POOL_CORRUPTED, HALE_PLAYER_HAND_FULL, HALE_OOB, HALE_BAD_INPUT, HALE_FUNC_NOT_IMPLEMENTED, HALE_AI_BADSTATE, HALE_NUM_STATUS} HALE_status_t;
