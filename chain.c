...
const char* chainConsoleColors[NUM_CHAINS] = {ANSI_COLOR_BRIGHT_RED, ANSI_COLOR_BRIGHT_YELLOW, ANSI_COLOR_YELLOW, ANSI_COLOR_BRIGHT_BLUE, ANSI_COLOR_BRIGHT_GREEN, ANSI_COLOR_BRIGHT_MAGENTA, ANSI_COLOR_BRIGHT_CYAN};
